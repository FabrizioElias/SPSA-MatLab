function [KEST, gdle, ngl, KELEM, ROT]=rigidez(PORTICO, ELEMENTOS, ~, DADOS)
%FAB - Acima, PAR foi substituido por ~, por aparentar não se utilizado.
% -------------------------------------------------------------------------
...
%FAB - Variável global m não é utilizada nesse script.
%global m
...
%FAB - Prealocação da matriz
gdle = zeros(PORTICO.nelem, 6);
...
for i=1:PORTICO.nelem
    ...
    if DADOS.op_spring==1
        ...
        kelem(5,5)=kelem(5,5)+PORTICO.springs(a,1);
    end
