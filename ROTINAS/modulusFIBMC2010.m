...
Eci=PAR.CONC.Ec0.parest1*PAR.CONC.alfaE.parest1*((fcm/1000)/10)^(1/3);  % <-- Divisão por mil para transformar de kN/m2 para MPa

% Módulo de elasticidade secante aos 28 dias
alfai=0.8+0.2*(fcm/1000)/88;    % <-- Divisão por mil para transformar de kN/m2 para MPa
Ecs=alfai*Eci;