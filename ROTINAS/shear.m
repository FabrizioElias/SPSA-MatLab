...
V=zeros(PORTICO.nelem,maxelem+1);
%FAB - Abaixo, o número de colunas (2) é sempre suficiente?
%FAB - A remoção dessas variáveis não deve alterar nada.
%VP = zeros(PORTICO.nelem, 2);
%VQ = zeros(PORTICO.nelem, 2);
...
for j=1:PORTICO.nelem    
    ...
    for i=1:s(2)
        ...
        % Vp - esforço cortante devido às cargas concentradas
        %VP(j,1:s(2))=Vp; 
