function [DADOS] = gains_model1D(OTIM,DADOS, ELEMENTOS, PILAR, VIGA, PAR, PORTICO, FLUXOCAIXA)
...
%-----------------------------------------------------------%
        secaoplus=thetaplus;
        ELEMENTOS = assignsections(ELEMENTOS, PILAR, VIGA, secaoplus); 
        ...
        ELEMENTOS = assignsections(ELEMENTOS, PILAR, VIGA, secaominus); 
