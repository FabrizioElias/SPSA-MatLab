%FAB - Remoção de argumento sem uso (CORTANTE).
function [PILARresult]=column(PILARresult, PORTICO, ELEMENTOS, DADOS, ~, MOMENTO, NORMAL, PILAR, PAR, qntbitolas, ESTRUTURAL)
% -------------------------------------------------------------------------
...
%     PILARin.comp=PORTICO.comp(PILAR.elemento(NumPilar));   % Comprimento
    ...
    [PILARout]=column0(MOMENTO, NORMAL, PILARin, pilar, NumPilar);
