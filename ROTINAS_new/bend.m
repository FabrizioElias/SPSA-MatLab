...
M=zeros(PORTICO.nelem,maxelem+1);

% Diagrama de Momento Fletor
%FAB - Prealocação de matrizes. O número de colunas (2) é sempre
%suficiente?
%FAB - Remover essas variáveis não deve alterar nada.
%MP = zeros(PORTICO.nelem, 2);
%MQ = zeros(PORTICO.nelem, 2);
%MM = zeros(PORTICO.nelem, 2);
