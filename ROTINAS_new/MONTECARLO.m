function [ELEMENTOS, COST, VPL, PAR] = MONTECARLO(DADOS, PAR, ELEMENTOS, PORTICO, VIGA, PILAR, FLUXOCAIXA)
% -------------------------------------------------------------------------
...
% 2.1 - SIMULAÇÃO DA ESTRUTURA
    if DADOS.op_simulador==1
        ...
        [MOMENTO, CORTANTE, NORMAL, VIGA, PILAR, DADOS, PAR, ELEMENTOS, ~, ~, ~]=PorticoPlano(DADOS, PORTICO, ELEMENTOS, VIGA, PILAR,PAR, ESTRUTURAL);
    else
