...
%FAB - Remoção de variável sem uso (msg).
[fidinc7, ~] = fopen(DADOS.filepar7,'r');%Abre o arquivo com as médias e DP dos elementos 
...
while ~feof(fidinc7)
        ...
        for i=1:PORTICO.nelem
            %FAB - Troca de str2num por str2double para melhor performance e remoação de variável sem uso.
            %X=fgets(fidinc7);
            aux = str2double(fgets(fidinc7));
