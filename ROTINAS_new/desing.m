function [PILARresult, VIGAresult]=desing(PORTICO, ELEMENTOS, DADOS, CORTANTE, MOMENTO, NORMAL, VIGA, PILAR, PAR, ESTRUTURAL)
% -------------------------------------------------------------------------
...
% -------------------------------------------------------------------------
    ...
    VIGAresult.lixo=0;
    VIGAresult=beam(PORTICO, ELEMENTOS, DADOS, CORTANTE, MOMENTO, NORMAL, VIGA, PAR, VIGAresult, ESTRUTURAL);
    % 2.0.6.2 - Pilares - A rotina column.m gerencia as demais rotinas
    disp('3.2 - PILARES')
    s=size(PILAR.TABELALONG);
    qntbitolas=s(2);
    PILARresult.lixo=0;
    [PILARresult]=column(PILARresult, PORTICO, ELEMENTOS, DADOS, CORTANTE, MOMENTO, NORMAL, PILAR, PAR, qntbitolas, ESTRUTURAL);