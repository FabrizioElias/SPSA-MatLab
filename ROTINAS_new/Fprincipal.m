...
nomearquivoTremTipo=('ROD-1-TREMTIPO-PortINPUTponte1.txt');
nomearquivoEmpSolo=('ROD-1-rEMPSOLO-PortINPUTponte1.txt');
...
if DADOS.op_exec==3
    ...
    if DADOS.op_gain==1
        ...
        [DADOS] = gains_model1D(OTIM, DADOS, ELEMENTOS, PILAR, VIGA, PAR, PORTICO, VPL, ESTRUTURAL, CORTANTE, MOMENTO, NORMAL, TRANSX, TRANSZ, ROTACAO, CARGASOLO, FLUXOCAIXA, COST);
        disp('-----------------------------------------------------------------')
    else
    ...
    ESTATISTICA=fobjetivo(VIGA, PILAR, DADOS, PAR, ELEMENTOS, PORTICO, FLUXOCAIXA, COST, VPL, ESTRUTURAL, CORTANTE, MOMENTO, NORMAL, TRANSX, TRANSZ, ROTACAO, CARGASOLO);
    ...
    [X, ys, vak, vck, vsknorm] = spsab(OTIM, DADOS, VIGA, PILAR, PAR, ELEMENTOS, PORTICO, FLUXOCAIXA, ESTRUTURAL,...
...
% Apaga variáveis
%     clear CORTANTE COST D DADOS ELEMENTOS ESTRUTURAL FLUXOCAIXA MOMENTO...
%         NORMAL PAR PILAR PORTICO ROTACAO TRANSX TRANSZ TRANSY VIGA VPL s
