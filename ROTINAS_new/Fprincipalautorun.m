...
arquivoinput='ROD-1-rEMPSOLO-PortINPUTponte1.txt';
...
if DADOS.op_exec==0
    ...
    % PORTICO.springsV.
    PORTICO.springsV=PORTICO.springs;
...
% 2.0.1 - PROCESSA O PÓRTICO PLANO - PorticoPlano.m
    ...
    [MOMENTO, CORTANTE, NORMAL, VIGA, PILAR, DADOS, PAR, ELEMENTOS, TRANSX, TRANSZ, ROTACAO]=PorticoPlano(CORTANTE,...
            MOMENTO, NORMAL, TRANSX, TRANSZ, ROTACAO, DADOS, PORTICO, ELEMENTOS, VIGA, PILAR,PAR, ESTRUTURAL);      
...
if DADOS.op_exec==1
    ...
    % Esforços internos e deslocamentos totais
    save(nomearquivo)
    % Plota o histograma
%     desl=zeros(1,DADOS.NMC);
%     for k=1:DADOS.NMC
%         A=TRANSX.TD{:,:,I};
%         desl(k)=A(1,16);
%     end
