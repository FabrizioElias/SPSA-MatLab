...
switch op_exec
    case 1
        ...
        %FAB - Troca de 'func' por uma mensagem anunciando sua inexistência.
        %fprintf(fid,'Valor da Funcao Objetivo: %0.2f',func);
        fprintf(fid,'Valor da Funcao Objetivo: INEXISTENTE');
        fprintf(fid,'\n-----------------------------------------------------------------\n');
    case 2
        fprintf(fid,'\n-----------------------------------------------------------------\n');
        ...
        fprintf(fid,'%0.2f\n',X);
        %FAB - Nenhuma variável desse if existe, foram removidas.
%         if op_minimax==2
%             func0=-func0;
%             func=-func;
%         end
        %FAB - Troca de 'func' e 'func0' por uma mensagem anunciando sua inexistência.
        %fprintf(fid,'\nValor Inicial da Funçao Objetivo: %0.2f\n',func0);
        %fprintf(fid,'Valor Final da Funcao Objetivo: %0.2f\n',func);
        fprintf(fid,'\nValor Inicial da Funçao Objetivo: INEXISTENTE\n');
        fprintf(fid,'Valor Final da Funcao Objetivo: INEXISTENTE\n');
        fprintf(fid,'\n-----------------------------------------------------------------\n');
